...
public class DCLockClockTest {
    @Test
    public void testDCLockClock (){
        List<MockMachine> machines = new ArrayList<>();
        List<Integer> clockLogger = new ArrayList<>();
        Object logMutex = new Object();
        for(int i = 0; i < 10; ++i){
            machines.add(new MockMachine(i, ClockDCLock.getInstance(), clockLogger, logMutex));
